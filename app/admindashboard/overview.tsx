...
const DashboardOverview: React.FC = () => {
  ...
  return (
    <div className="p-4 shadow rounded-md container w-screen flex flex-col">
      <Box>
        ...
        {loading ? (
          ...
          <>
            ...
            <Grid container spacing={2}>
              {[
                { label: 'Total Transactions', value: data.metrics.totalTransactions },
                { label: 'Total Revenue (₦)', value: data.metrics.totalRevenue.toLocaleString() },
                { label: 'Total Users', value: data.metrics.totalUsers },
                { label: 'Total Wallet Balance (₦)', value: data.metrics.totalWalletBalance.toLocaleString() },
                { label: 'Profit (₦)', value: data.metrics.profit.toLocaleString() },
