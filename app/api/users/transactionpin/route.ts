...
//     return NextResponse.json({ message: "Transaction PIN set successfully" }, { status: 200 });
//   } catch (error) {
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ hasPin: false, message: "Transaction PIN set successfully" }, { status: 200 });
  } catch (error) {
